...
class Container(AppContainer):
    ...
    def on_mount(self) -> None:
        ...
        box_one.write("This view is not focusable because cursor is disabled")

        box_two.border_title = "Single Line"
        box_two.write("I am a single line of text but you can still navigate me")

        box_text = Text("This is how you can navigate multi-line text", style=self.style_msg)
        box_three.border_title = "Multi Line"
        box_three.write(self.merge_text.join([box_text, Text(TEXT_ONE)]))
        ...
        box_four.write(self.merge_text.join([box_text, Text(TEXT_TWO)]))
        ...
        box_five.write(self.merge_text.join([Text(TEXT_TWO), box_text]))

        box_text = Text("This one scroll both ways", style=self.style_msg)
        box_six.border_title = "Scroll Both Ways"
        box_six.write(self.merge_text.join([Text(TEXT_TWO), box_text]), shrink=False)
