...
from feathers.utils import line_crop
...
class Input(Widget, can_focus=True):
    ...
    def watch_cursor_position(self, cursor_position: int) -> None:
        ...
        self.log("|----------watch_cursor_pos------------|")
        self.log(f"cursor_offset: {cursor_offset}")
        self.log(f"view_start: {view_start}")
        self.log(f"view_end: {view_end}")
        self.log(f"view_position: {self.view_position}")
